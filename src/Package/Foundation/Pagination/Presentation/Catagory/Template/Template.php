<?php
namespace Ababilitworld\FlexPortfolioByAbabilitworld\Package\Pagination\Presentation\Catagory\Template;
...
if (!class_exists(__NAMESPACE__.'\Template')) 
{
     ...
     * Return the instance
     *
     * @return \Ababilitworld\FlexPortfolioByAbabilitworld\Package\Pagination\Presentation\Catagory\Template\Template
     */
    function template() 
    {
